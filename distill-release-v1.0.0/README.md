...
**The complete toolkit for converting websites to clean Markdown.**
...
- `distill-gui` — Experimental desktop GUI for graphics-capable machines
...
- Optional experimental desktop GUI workflow
