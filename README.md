...
WSKY Distiller is a small Rust toolkit for turning webpages into clean Markdown.
...
- `distill-gui` - experimental desktop workflow for graphics-capable machines
...
- Treat `distill-gui` as an optional experimental front end
...
- `distill-gui` is included, but the primary supported interfaces are the CLI and TUI
